...
This directory contains BountyReper skills for the CIS AWS End User Compute Services Benchmark v1.2.0.
...
Each skill can be invoked individually via BountyReper CLI:

```bash
bountyreper run cis-aws-euc-4.1  # WorkDocs IAM admin control
bountyreper run cis-aws-euc-5.1  # AppStream VPC control
```
