# CIS Apache Tomcat 8 Benchmark v1.0.0 - BountyReper Skills

This directory contains **61 CIS benchmark controls** for Apache Tomcat 8, organized as BountyReper SKILL.md files.
...
Each control is implemented as a BountyReper skill that can be invoked during security assessments:

```bash
bountyreper run /cis-tomcat8-v100-1.1
bountyreper run /cis-tomcat8-v100-4.1
```
