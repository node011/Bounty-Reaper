...
### Usage in BountyReper

These skills can be invoked in BountyReper to audit AWS EDR configurations:

```bash
# Audit all Section 6 controls
bountyreper run "Audit CIS AWS Storage Section 6 controls"

# Audit specific control
bountyreper run "Check CIS 6.1 - EDR Configuration"

# Remediate specific control
bountyreper run "Remediate CIS 6.5 - IAM for EDR"
```
