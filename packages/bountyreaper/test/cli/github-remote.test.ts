...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bountyreaper.git")).toEqual({ owner: "sst", repo: "bountyreaper" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bountyreaper")).toEqual({ owner: "sst", repo: "bountyreaper" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bountyreaper.git")).toEqual({ owner: "sst", repo: "bountyreaper" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bountyreaper")).toEqual({ owner: "sst", repo: "bountyreaper" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bountyreaper.git")).toEqual({ owner: "sst", repo: "bountyreaper" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bountyreaper")).toEqual({ owner: "sst", repo: "bountyreaper" })
})
