...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BOUNTYREAPER_CALLER", () => {
    process.env["BOUNTYREAPER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BOUNTYREAPER_CALLER", () => {
    process.env["BOUNTYREAPER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BOUNTYREAPER_CALLER", () => {
    process.env["BOUNTYREAPER_CALLER"] = "unknown"
