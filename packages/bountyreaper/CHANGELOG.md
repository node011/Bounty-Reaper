...
All notable changes to BountyReaper will be documented in this file.
...
- `knowledge/` directory (migrated to `.bountyreaper/skill/WEB/OWASP_WSTG_4.2/`)
...
**Full Changelog**: https://github.com/node011/Bounty-Reaper/compare/v1.1.9...v1.1.10
