<p align="center">
  <img src="https://raw.githubusercontent.com/node011/Bounty-Reaper/dev/assets/social-preview-dark.svg" alt="BountyReaper" width="800">
</p>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@bountyreaper-io/bountyreaper"><img alt="npm" src="https://img.shields.io/npm/v/@bountyreaper-io/bountyreaper?style=flat-square&color=00ff41" /></a>
  <a href="https://www.npmjs.com/package/@bountyreaper-io/bountyreaper"><img alt="Downloads" src="https://img.shields.io/npm/dm/@bountyreaper-io/bountyreaper?style=flat-square&color=00ff41" /></a>
  <a href="https://github.com/node011/Bounty-Reaper/actions/workflows/publish.yml"><img alt="Build" src="https://img.shields.io/github/actions/workflow/status/node011/Bounty-Reaper/publish.yml?style=flat-square&branch=dev" /></a>
  <a href="https://discord.gg/snunAaHf6U"><img alt="Discord" src="https://img.shields.io/discord/1391832426048651334?style=flat-square&label=discord&color=00ff41" /></a>
  <a href="https://github.com/node011/Bounty-Reaper/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/badge/license-MIT-00ff41?style=flat-square" /></a>
</p>
...
cd Bounty-Reaper && ./script/bootstrap.sh && bun dev
```

That's it. BountyReaper launches a TUI in your terminal, asks for your LLM provider and API key on first run, and you're ready to go. Tell it what to test — it loads relevant skills from 7,300+ MITRE ATT&CK, CIS, OWASP, and NIST test procedures, then handles reconnaissance, vulnerability discovery, exploitation, and reporting autonomously.

> **Already have a Claude Code or OpenAI subscription?** BountyReaper's intelligence layer sits on top of your existing AI subscription. No separate API costs — your current plan powers an entire pentest toolkit.
...
BountyReaper isn't just a wrapper around an LLM. It's an intelligence layer that transforms any AI model into an offensive security specialist.

**How it works:** When you connect your LLM provider, BountyReaper injects domain-specific context — OWASP testing methodology, vulnerability patterns, attack chain reasoning, and tool orchestration logic — into every interaction. The model doesn't need to know security; BountyReaper teaches it.
...
> **Air-gapped environments?** Run BountyReaper entirely offline with Ollama or LM Studio. No data leaves your machine — ever.

---

### Skills System — 7,300+ Actionable Security Tests

BountyReaper doesn't just give agents generic security knowledge — it loads domain-specific skills on-demand with zero context pollution.
...
Read more: [MITRE ATT&CK Integration](https://github.com/node011/Bounty-Reaper/blob/main/.bountyreaper/skill/mitre_attack/), [CIS Benchmarks](https://github.com/node011/Bounty-Reaper/tree/main/.bountyreaper/skill/CIS_benchmarks)
...
Most AI security tools are thin wrappers that send your prompt to an API. BountyReaper's intelligence layer normalizes outputs across 15+ providers, guards context between test phases, auto-detects your provider configuration, and orchestrates multi-step attack chains. The result: consistent, methodology-driven pentesting regardless of which model you use.
...
Anthropic, OpenAI, Google, Amazon Bedrock, Azure, Groq, Mistral, DeepSeek, OpenRouter, Together AI — or run fully offline with Ollama and LM Studio. You choose the model. You own the results. As AI models get better and cheaper, BountyReaper gets better with them. Switch providers in seconds without reconfiguring anything.
...
Your security tools don't have to run on your laptop. Deploy Bolt on one or many remote servers, pair with Ed25519 keys, and control everything from your local terminal. One BountyReaper instance can orchestrate dozens of Bolt servers — each with its own toolkit, network position, and attack surface access.
...
| ---------------------- | ------- | ------------------------------------------------------------------- |
| **bountyreaper**        | General | Full-access primary agent — reconnaissance, exploitation, reporting |
...
Run `bountyreaper web` and control your agents, MCP servers, Bolt connections, and vulnerability findings from any browser. Access from anywhere with Cloudflare Tunnel — zero open ports, end-to-end encryption, password-protected API. Your data stays on your machine.

```bash
export BOUNTYREAPER_SERVER_PASSWORD=your-secure-password
bountyreaper web
```

Use **[app.bountyreper.io](https://app.bountyreper.io)** (static page, no backend) or self-host from `packages/app/dist/`.

See the [full README](https://github.com/node011/Bounty-Reaper#web-ui--remote-access) for the complete security model.

---

### Bolt — Remote Tool Execution

Bolt is BountyReaper's remote tool server. Deploy it on any VPS, cloud instance, or Docker container — then control it from your local terminal over MCP protocol with Ed25519 authentication.

**One BountyReaper, many Bolt servers:**
...
│  BountyReaper TUI │ ◄─────────────►├───►│  Bolt Server #2     │
...
- **Manage from TUI** — Add, remove, and monitor Bolt servers without leaving BountyReaper
...
BountyReaper connects to specialized MCP servers that extend its capabilities — **176+ security tools** across 5 domains:
...
All open source. All installable with `npx`. Plug them into BountyReaper or use them standalone with any MCP-compatible client.

---

### Built-in Tools

BountyReaper agents have direct access to 30+ tools without any external dependencies:
...
**Clone and build — the only supported method.** BountyReaper is not published to
...
- **Bug Bounty Hunters** — Faster reconnaissance, wider coverage, consistent methodology across programs. BountyReaper doesn't get tired at 3am.
...
- **Security Researchers** — Extend BountyReaper with custom agents and MCP servers. The plugin system and MCP protocol make it a platform, not just a tool.

---

### Contributing

BountyReaper is built by the security community, for the security community. We welcome contributions across:
...
Read the [Contributing Guide](https://github.com/node011/Bounty-Reaper/blob/main/CONTRIBUTING.md) before submitting a PR. All contributions must follow the project's [ethical use policy](https://github.com/node011/Bounty-Reaper/blob/main/CODE_OF_CONDUCT.md) — BountyReaper is for authorized security testing only.

---

### License

[MIT](https://github.com/node011/Bounty-Reaper/blob/main/LICENSE) — see NOTICE for third-party attributions.

---

### MCP Security Suite

BountyReaper is the core platform. These MCP servers extend its capabilities:

| Project                                                                | Domain                                  | Tools                                       |
| ---------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------- |
| **BountyReaper**                                                        | **Autonomous offensive security agent** | **7,300+ skills (MITRE, CIS, OWASP, NIST)** |
...
<p align="center">
  <a href="https://bountyreper.io"><b>bountyreper.io</b></a> · <a href="https://docs.bountyreper.io"><b>Docs</b></a> · <a href="https://discord.gg/snunAaHf6U"><b>Discord</b></a> · <a href="https://x.com/bountyreaperio"><b>X.com</b></a> · <a href="https://github.com/node011/Bounty-Reaper"><b>GitHub</b></a>
</p>
<p align="center">
