...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the BountyReaper server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Check if a newer version of BountyReaper is available.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the BountyReaper system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global BountyReaper configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global BountyReaper configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all BountyReaper instances, releasing all resources.",
