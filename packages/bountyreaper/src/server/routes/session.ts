  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all BountyReaper sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific BountyReaper session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new BountyReaper session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      async (c) => {
        ...
        const ingestDryRun = process.env.BOUNTYREAPER_INGEST_DRY_RUN === "true"
