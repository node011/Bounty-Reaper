...
import * as mod_ad_cert_trust from "./ad-cert-trust"
import * as mod_ad_enum from "./ad-enum"
import * as mod_ad_exploit from "./ad-exploit"
import * as mod_credential from "./credential"
import * as mod_evasion from "./evasion"
import * as mod_exfil from "./exfil"
import * as mod_hybrid from "./hybrid"
import * as mod_injection from "./injection"
import * as mod_kerberos from "./kerberos"
...
const PROGRAMS = {
  ...
  defender_exclude: {
    description:
      "Add exclusion paths to Windows Defender via PowerShell to prevent scanning of BountyReaper tools and payloads",
    args: "--path PATH",
  },
  cleanup_win: {
    description:
      "Remove BountyReaper artifacts — clear Security/System/Application event logs, remove scheduled tasks, restore AMSI/ETW patches, delete temp files. ALWAYS run before leaving a target",
    args: "",
  },
  ad_enum: {
    description:
...
const CATEGORY_MODULES: Array<[string, Record<string, unknown>]> = [
  ["ad-cert-trust", mod_ad_cert_trust],
  ["ad-enum", mod_ad_enum],
  ["ad-exploit", mod_ad_exploit],
  ["credential", mod_credential],
  ["evasion", mod_evasion],
  ["exfil", mod_exfil],
  ["hybrid", mod_hybrid],
  ["injection", mod_injection],
  ["kerberos", mod_kerberos],
  ["lateral", mod_lateral],
  ["network", mod_network],
