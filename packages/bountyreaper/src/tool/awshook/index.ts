...
const PROGRAMS = {
  ...
  cleanup_aws: {
    description:
      "Remove all BountyReaper-created AWS resources (IAM, Lambda, snapshots, stacks, rules), restore CloudTrail logging. ALWAYS run before leaving",
  ...
  async execute(params, ctx) {
    ...
    try {
      await Gate.ask(ctx, {
        ...
        category: categoryOf(params.program),
