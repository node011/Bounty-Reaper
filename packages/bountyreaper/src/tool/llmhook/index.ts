...
import * as mod_abuse from "./abuse"
import * as mod_evasion from "./evasion"
import * as mod_extraction from "./extraction"
import * as mod_injection from "./injection"
import * as mod_jailbreak from "./jailbreak"
import * as mod_multiturn from "./multiturn"
import * as mod_recon from "./recon"
import * as mod_safety from "./safety"
...
const CATEGORY_MODULES: Array<[string, Record<string, unknown>]> = [
  ["abuse", mod_abuse],
  ["evasion", mod_evasion],
  ["extraction", mod_extraction],
  ["injection", mod_injection],
  ["jailbreak", mod_jailbreak],
  ["multiturn", mod_multiturn],
  ["recon", mod_recon],
  ["safety", mod_safety],
]
...
export const LlmhookTool = Tool.define("llmhook", {
  ...
  async execute(params, toolCtx) {
    ...
    await Gate.ask(toolCtx, { tool: "llmhook", program, category: categoryOf(program), detail: { args: params.args } })
