...
import * as mod_cleanup from "./cleanup"
...
const PROGRAMS = {
  ...
  cleanup_gcp: {
    description:
      "Remove all BountyReaper GCP artifacts: snapshots, functions, Run services, scheduler jobs, build triggers, firewall rules. ALWAYS run before leaving",
