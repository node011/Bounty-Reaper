...
import * as mod_monitoring from "./monitoring"
...
const PROGRAMS = {
  ...
  artifact_enum: {
    description: "Pre-cleanup audit — find all BountyReaper artifacts before cleanup",
    args: "",
  },
  cleanup_mac: {
    description:
      "Remove BountyReaper artifacts — LaunchAgents, processes, temp files, DTrace scripts, history. ALWAYS run before leaving",
    args: "",
  },
