...
<html>
  <head>
    <title>BountyReaper - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to BountyReaper.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>BountyReaper - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput): Promise<Hooks> {
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "bountyreaper"
      output.headers["User-Agent"] =
        `bountyreaper/${Installation.VERSION} (${os.platform()} ${os.release()}; ${os.arch()})`
