...
export namespace SkillSigning {
  ...
  // BountyReaper official Ed25519 public key (base64-encoded raw 32-byte key)
  // Used to verify skills signed by the BountyReaper team.
  ...
  export async function verify(skill: {
    ...
    if (skill.signed_by !== "bountyreaper-official" || !skill.signature) return "community"
