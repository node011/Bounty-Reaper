...
export namespace Skill {
  ...
  const BOUNTYREAPER_SKILL_GLOB = new Bun.Glob("{skill,skills}/**/SKILL.md")
  ...
  export const state = Instance.state(async () => {
    ...
    if (!Flag.BOUNTYREAPER_DISABLE_EXTERNAL_SKILLS) {
    ...
    // Scan .bountyreaper/skill/ directories
    for (const dir of await Config.directories()) {
      for await (const match of BOUNTYREAPER_SKILL_GLOB.scan({
        cwd: dir,
        absolute: true,
        onlyFiles: true,
        followSymlinks: true,
