#!/usr/bin/env node
// Hackbrowser worker — runs as a subprocess of the main bountyreaper binary.
...
import { runCrawl } from "@bountyreaper-io/hackbrowser/api"
import type { CrawlOptions, LogRecord, CSEvent } from "@bountyreaper-io/hackbrowser/api"
