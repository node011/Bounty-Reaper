...
import type { AssistantMessage } from "@bountyreaper-io/sdk/v2"
    ...
    <Show when={session()}>
      ...
      >
        ...
        <box flexShrink={0} gap={1} paddingTop={1}>
          <Show when={!hasProviders() && !gettingStartedDismissed()}>
            ...
            >
              ...
              <box flexGrow={1} gap={1}>
                ...
                <text fg={theme.textMuted}>BountyReaper includes free models so you can start immediately.</text>
                <text fg={theme.textMuted}>
          ...
          <text fg={theme.textMuted}>
            <span style={{ fg: theme.success }}>•</span> <b>Bounty</b>
