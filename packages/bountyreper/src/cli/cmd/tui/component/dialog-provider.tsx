...
import type { ProviderAuthAuthorization } from "@bountyreper-io/sdk/v2"
...
function ApiMethod(props: ApiMethodProps) {
  ...
  return (
    <DialogPrompt
      ...
      placeholder="API key"
      description={
        props.providerID === "bountyreper" ? (
          <box gap={1}>
            <text fg={theme.textMuted}>
              BountyReper Zen gives you access to all the best coding models at the cheapest prices with a single API
              key.
            </text>
            <text fg={theme.text}>
...
function LocalDoneStep(props: { providerID: string; modelIDs: string[] }) {
  ...
  return (
    <box paddingLeft={2} paddingRight={2} gap={1} paddingBottom={1}>
      ...
      <text fg={theme.textMuted}>{"Use: bountyreper --model " + props.providerID + "/" + props.modelIDs[0]}</text>
    </box>
  )
}
