  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all BountyReper sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific BountyReper session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new BountyReper session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      async (c) => {
        ...
        const ingestDryRun = process.env.BOUNTYREPER_INGEST_DRY_RUN === "true"
