...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the BountyReper server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Check if a newer version of BountyReper is available.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the BountyReper system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global BountyReper configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global BountyReper configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all BountyReper instances, releasing all resources.",
