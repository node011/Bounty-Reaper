    ...
    () =>
      ...
      app
        ...
        .use(
          cors({
            origin(input) {
              ...
              if (/^https:\/\/([a-z0-9-]+\.)*bountyreper\.io$/.test(input)) {
                return input
              }
            ...
            credentials: true,
            allowHeaders: ["Authorization", "Content-Type", "x-bountyreper-directory"],
          }),
        )
        .use(async (c, next) => {
          if (c.req.method === "OPTIONS") return next()
          const password = Flag.BOUNTYREPER_SERVER_PASSWORD
          ...
          const username = Flag.BOUNTYREPER_SERVER_USERNAME ?? "bountyreper"
        ...
        .use(async (c, next) => {
          ...
          const explicit = c.req.query("directory") || c.req.header("x-bountyreper-directory")
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current BountyReper instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the BountyReper system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the BountyReper system.",
        ...
        .all("/*", async (c) => {
          ...
          if (!_serveWebUI)
            return c.json(
              { error: "API-only mode. Use app.bountyreper.io or 'bountyreper web' for the web interface." },
              404,
            )
          ...
          if (_webDistDir === undefined) {
            const candidates = [
              // 1. ~/.bountyreper/web/ (installed/production)
