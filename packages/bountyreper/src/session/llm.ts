...
export namespace LLM {
  ...
  export async function stream(input: StreamInput) {
    ...
    return streamText({
      ...
      headers: {
        ...(input.model.providerID.startsWith("bountyreper") || input.model.providerID.startsWith("opencode")
          ? {
              "x-bountyreper-project": Instance.project.id,
              "x-bountyreper-session": input.sessionID,
              "x-bountyreper-request": input.user.id,
              "x-bountyreper-client": Flag.BOUNTYREPER_CLIENT,
              ...
              "x-opencode-client": Flag.BOUNTYREPER_CLIENT,
            }
