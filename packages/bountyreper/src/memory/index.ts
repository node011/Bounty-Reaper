...
export namespace Memory {
   ...
   * Uses .bountyreper/memory/ in project root or global config
   */
  export function getMemoryDir(): string {
    const projectMemory = path.join(Instance.worktree, ".bountyreper", "memory")
  ...
  export function getMemoryFile(): string {
    return path.join(Instance.worktree, ".bountyreper", "MEMORY.md")
  }
