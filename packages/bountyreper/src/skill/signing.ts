...
export namespace SkillSigning {
  ...
  // BountyReper official Ed25519 public key (base64-encoded raw 32-byte key)
  // Used to verify skills signed by the BountyReper team.
  ...
  export async function verify(skill: {
    ...
    if (skill.signed_by !== "bountyreper-official" || !skill.signature) return "community"
