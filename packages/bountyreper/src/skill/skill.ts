...
export namespace Skill {
  ...
  const BOUNTYREPER_SKILL_GLOB = new Bun.Glob("{skill,skills}/**/SKILL.md")
  ...
  export const state = Instance.state(async () => {
    ...
    if (!Flag.BOUNTYREPER_DISABLE_EXTERNAL_SKILLS) {
    ...
    // Scan .bountyreper/skill/ directories
    for (const dir of await Config.directories()) {
      for await (const match of BOUNTYREPER_SKILL_GLOB.scan({
        cwd: dir,
        absolute: true,
        onlyFiles: true,
        followSymlinks: true,
