...
All notable changes to BountyReper will be documented in this file.
...
- `knowledge/` directory (migrated to `.bountyreper/skill/WEB/OWASP_WSTG_4.2/`)
...
**Full Changelog**: https://github.com/bounty-reper/BountyReper/compare/v1.1.9...v1.1.10
