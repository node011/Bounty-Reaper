...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bountyreper.git")).toEqual({ owner: "sst", repo: "bountyreper" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bountyreper")).toEqual({ owner: "sst", repo: "bountyreper" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bountyreper.git")).toEqual({ owner: "sst", repo: "bountyreper" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bountyreper")).toEqual({ owner: "sst", repo: "bountyreper" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bountyreper.git")).toEqual({ owner: "sst", repo: "bountyreper" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bountyreper")).toEqual({ owner: "sst", repo: "bountyreper" })
})
