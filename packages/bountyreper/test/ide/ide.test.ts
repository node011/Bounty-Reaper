...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BOUNTYREPER_CALLER", () => {
    process.env["BOUNTYREPER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BOUNTYREPER_CALLER", () => {
    process.env["BOUNTYREPER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BOUNTYREPER_CALLER", () => {
    process.env["BOUNTYREPER_CALLER"] = "unknown"
