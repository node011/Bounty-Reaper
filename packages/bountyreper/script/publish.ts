...
const skillSrcPath = "../../.bountyreper/skill"
...
// Global.Path.bin (~/.local/share/bountyreper/bin/) so the main binary can
  ...
  JSON.stringify(
    {
      ...
      repository: {
        type: "git",
        url: "https://github.com/bounty-reper/BountyReper.git",
      },
      dependencies: {
...
const tasks = Object.entries(binaries).map(async ([name]) => {
  // name is scoped like "@bountyreper-io/bountyreper-darwin-arm64"
  // directory on disk is just "bountyreper-darwin-arm64"
