export const dict = {
  ...
  "dialog.provider.bountyreper.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af BountyReper",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i BountyReper.",
  ...
  "provider.connect.bountyreperZen.line1":
    "BountyReper Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.bountyreperZen.visit.prefix": "Besøg ",
  "provider.connect.bountyreperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreperZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i BountyReper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i BountyReper.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i bountyreper.json",
  ...
  "dialog.server.description": "Skift hvilken BountyReper-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af BountyReper ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til BountyReper-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (bountyreper.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, BountyReper understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "BountyReper inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør BountyReper-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for BountyReper",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan BountyReper ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan BountyReper er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når BountyReper starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af BountyReper.",
