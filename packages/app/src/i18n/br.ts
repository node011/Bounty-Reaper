export const dict = {
  ...
  "dialog.provider.bountyreaper.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo BountyReaper",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no BountyReaper.",
  ...
  "provider.connect.bountyreaperZen.line1":
    "BountyReaper Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.bountyreaperZen.visit.prefix": "Visite ",
  "provider.connect.bountyreaperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreaperZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no BountyReaper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no BountyReaper.",
  ...
  "dialog.plugins.empty": "Plugins configurados em bountyreaper.json",
  ...
  "dialog.server.description": "Trocar para qual servidor BountyReaper este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do BountyReaper ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do BountyReaper",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (bountyreaper.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: BountyReaper ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "BountyReaper inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor BountyReaper dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do BountyReaper",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o BountyReaper aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o BountyReaper é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o BountyReaper iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do BountyReaper.",
