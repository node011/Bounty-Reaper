...
export const dict = {
  ...
  "dialog.provider.bountyreaper.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BountyReaper",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i BountyReaper.",
  ...
  "provider.connect.bountyreaperZen.line1":
    "BountyReaper Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.bountyreaperZen.visit.prefix": "Besøk ",
  "provider.connect.bountyreaperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreaperZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i BountyReaper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i BountyReaper.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i bountyreaper.json",
  ...
  "dialog.server.description": "Bytt hvilken BountyReaper-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BountyReaper ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BountyReaper-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (bountyreaper.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BountyReaper ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BountyReaper inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BountyReaper-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BountyReaper",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BountyReaper ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan BountyReaper er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BountyReaper starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BountyReaper.",
