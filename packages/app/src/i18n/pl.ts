export const dict = {
  ...
  "dialog.provider.bountyreaper.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BountyReaper",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BountyReaper.",
  ...
  "provider.connect.bountyreaperZen.line1":
    "BountyReaper Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.bountyreaperZen.visit.prefix": "Odwiedź ",
  "provider.connect.bountyreaperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreaperZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BountyReaper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BountyReaper.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w bountyreaper.json",
  ...
  "dialog.server.description": "Przełącz serwer BountyReaper, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BountyReaper ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BountyReaper",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (bountyreaper.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "BountyReaper zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BountyReaper",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BountyReaper na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BountyReaper.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BountyReaper",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BountyReaper.",
