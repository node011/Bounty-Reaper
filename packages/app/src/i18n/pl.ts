export const dict = {
  ...
  "dialog.provider.bountyreper.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BountyReper",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BountyReper.",
  ...
  "provider.connect.bountyreperZen.line1":
    "BountyReper Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.bountyreperZen.visit.prefix": "Odwiedź ",
  "provider.connect.bountyreperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreperZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BountyReper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BountyReper.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w bountyreper.json",
  ...
  "dialog.server.description": "Przełącz serwer BountyReper, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BountyReper ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BountyReper",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (bountyreper.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "BountyReper zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BountyReper",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BountyReper na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BountyReper.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BountyReper",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BountyReper.",
