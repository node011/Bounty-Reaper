export const dict = {
  ...
  "dialog.provider.bountyreper.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BountyReper",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BountyReper-u.",
  ...
  "provider.connect.bountyreperZen.line1":
    "BountyReper Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.bountyreperZen.visit.prefix": "Posjeti ",
  "provider.connect.bountyreperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreperZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BountyReper-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BountyReper-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u bountyreper.json",
  ...
  "dialog.server.description": "Promijeni na koji se BountyReper server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BountyReper-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BountyReper timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (bountyreper.json) provider/model names",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: BountyReper još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BountyReper uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BountyReper server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BountyReper-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BountyReper izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BountyReper-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BountyReper pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BountyReper-a.",
