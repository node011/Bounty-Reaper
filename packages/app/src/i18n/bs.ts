export const dict = {
  ...
  "dialog.provider.bountyreaper.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BountyReaper",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BountyReaper-u.",
  ...
  "provider.connect.bountyreaperZen.line1":
    "BountyReaper Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.bountyreaperZen.visit.prefix": "Posjeti ",
  "provider.connect.bountyreaperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreaperZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BountyReaper-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BountyReaper-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u bountyreaper.json",
  ...
  "dialog.server.description": "Promijeni na koji se BountyReaper server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BountyReaper-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BountyReaper timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (bountyreaper.json) provider/model names",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: BountyReaper još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BountyReaper uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BountyReaper server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BountyReaper-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BountyReaper izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BountyReaper-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BountyReaper pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BountyReaper-a.",
