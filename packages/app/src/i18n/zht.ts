...
export const dict = {
  ...
  "dialog.provider.bountyreper.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  ...
  "dialog.model.unpaid.freeModels.title": "BountyReper 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 BountyReper 中使用 {{provider}} 模型。",
  ...
  "provider.connect.bountyreperZen.line1": "BountyReper Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.bountyreperZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.bountyreperZen.visit.prefix": "造訪 ",
  "provider.connect.bountyreperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreperZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 BountyReper 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 BountyReper 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 bountyreper.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 BountyReper 伺服器。",
  ...
  "toast.update.description": "BountyReper 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 BountyReper 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (bountyreper.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: BountyReper 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "BountyReper 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 BountyReper 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 BountyReper 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 BountyReper 的主題。",
  ...
  "settings.updates.row.startup.description": "在 BountyReper 啟動時自動檢查更新",
