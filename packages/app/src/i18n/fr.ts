export const dict = {
  ...
  "dialog.provider.bountyreper.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par BountyReper",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans BountyReper.",
  ...
  "provider.connect.bountyreperZen.line1":
    "BountyReper Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.bountyreperZen.visit.prefix": "Visitez ",
  "provider.connect.bountyreperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreperZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans BountyReper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans BountyReper.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans bountyreper.json",
  ...
  "dialog.server.description": "Changez le serveur BountyReper auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'BountyReper ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe BountyReper",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (bountyreper.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'BountyReper ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "BountyReper inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur BountyReper dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour BountyReper",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'BountyReper sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'BountyReper.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'BountyReper",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'BountyReper.",
