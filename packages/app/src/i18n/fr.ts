export const dict = {
  ...
  "dialog.provider.bountyreaper.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par BountyReaper",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans BountyReaper.",
  ...
  "provider.connect.bountyreaperZen.line1":
    "BountyReaper Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.bountyreaperZen.visit.prefix": "Visitez ",
  "provider.connect.bountyreaperZen.visit.link": "bountyreper.io/zen",
  "provider.connect.bountyreaperZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans BountyReaper.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans BountyReaper.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans bountyreaper.json",
  ...
  "dialog.server.description": "Changez le serveur BountyReaper auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'BountyReaper ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe BountyReaper",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (bountyreaper.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'BountyReaper ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "BountyReaper inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur BountyReaper dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour BountyReaper",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'BountyReaper sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'BountyReaper.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'BountyReaper",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'BountyReaper.",
