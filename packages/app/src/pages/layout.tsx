...
import { ResizeHandle } from "@bountyreper-io/ui/resize-handle"
...
import { Session, type Message } from "@bountyreper-io/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@bountyreper-io/ui/toast"
...
import { useTheme, type ColorScheme } from "@bountyreper-io/ui/theme"
  ...
  const useUpdatePolling = () =>
    onMount(() => {
      ...
      const pollUpdate = () => {
        ...
        if (s.http.password) headers["Authorization"] = basicAuth(s.http.username ?? "bountyreper", s.http.password!)
