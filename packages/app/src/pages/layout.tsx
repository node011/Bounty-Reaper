...
import { ResizeHandle } from "@bountyreaper-io/ui/resize-handle"
...
import { Session, type Message } from "@bountyreaper-io/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@bountyreaper-io/ui/toast"
...
import { useTheme, type ColorScheme } from "@bountyreaper-io/ui/theme"
  ...
  const useUpdatePolling = () =>
    onMount(() => {
      ...
      const pollUpdate = () => {
        ...
        if (s.http.password) headers["Authorization"] = basicAuth(s.http.username ?? "bountyreaper", s.http.password!)
        ...
        >
          <div class="@container w-full h-full contain-strict">
            <SidebarContent
              ...
              onOpenHelp={() => platform.openLink("https://bountyreper.io/desktop-feedback")}
