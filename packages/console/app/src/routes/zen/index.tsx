...
import compareVideo from "../../asset/lander/bountyreper-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/bountyreper-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="bountyreper:auth" content={loggedin() ? "true" : "false"} />
