...
import compareVideo from "../../asset/lander/bountyreaper-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/bountyreaper-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="bountyreaper:auth" content={loggedin() ? "true" : "false"} />
