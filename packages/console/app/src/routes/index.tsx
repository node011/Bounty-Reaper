...
import video from "../asset/lander/bountyreper-min.mp4"
import videoPoster from "../asset/lander/bountyreper-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">bountyreper</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">bounty-reper/tap/bountyreper</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
