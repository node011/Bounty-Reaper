...
import video from "../asset/lander/bountyreaper-min.mp4"
import videoPoster from "../asset/lander/bountyreaper-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">bountyreaper</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">bounty-reper/tap/bountyreaper</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
